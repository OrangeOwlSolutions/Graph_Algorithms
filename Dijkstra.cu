...
//
//      The implementation in that paper has been recognized to be bugged, see
//
//			"CUDA Solutions for the SSSP Problem" vy
//			Pedro J. Martín, Roberto Torres, and Antonio Gavilanes
//
//		The below implementation is the implementation suggested in the first paper fixed
//		with the remark of the second.
